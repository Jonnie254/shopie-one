...
export class ProductController{
    ...
    async createItem(req: Request, res: Response){
        try{
            let {product_id, product_name, product_description, product_image, product_price, product_quantity, product_category} = req.body
    ...
    async updateItem(req: Request, res: Response){
        try{
            ...
            let {product_name, product_description, product_image, product_price, product_quantity, product_category} = req.body

            let products ={
                product_id: product_id,
                product_name, product_description, product_image, product_price, product_quantity, product_category
            }
